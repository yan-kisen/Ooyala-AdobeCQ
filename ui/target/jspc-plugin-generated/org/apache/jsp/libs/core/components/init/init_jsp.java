package org.apache.jsp.libs.core.components.init;
...
public final class init_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
if (WCMMode.fromRequest(request) != WCMMode.DISABLED) {
    ...
    if (editContext != null && editContext.getComponent() != null) {
      ...
      out.write(";\n");
      out.write("            // explicitly set page path, as under some circumstances, CQ.WCM.getPagePath()\n");
      out.write("            // may yield unwanted results at this point\n");
      out.write("            cfg.pagePath = \"");
      out.print( currentPage.getPath() );
      out.write("\";\n");
      out.write("\n");
      out.write("            if (CQClientLibraryManager.channelCB() != \"touch\") {\n");
      out.write("                CQ.undo.UndoManager.initialize(cfg);\n");
      out.write("                CQ.Ext.onReady(function() {\n");
      out.write("                    CQ.undo.UndoManager.detectCachedPage(");
      out.print( System.currentTimeMillis() );
      out.write(");\n");
      out.write("                });\n");
      out.write("            }\n");
      out.write("        })();\n");
      out.write("        CQ.WCM.launchSidekick(\"");
      out.print( currentPage.getPath() );
      out.write("\", {\n");
      out.write("            propsDialog: \"");
      out.print( dlgPath == null ? "" : dlgPath );
      out.write("\",\n");
      out.write("            locked: ");
      out.print( currentPage.isLocked() );
      out.write("\n");
      out.write("        });\n");
      out.write("    </script>\n");
 } 
  ...
  private boolean _jspx_meth_cq_005fincludeClientLib_005f0(PageContext _jspx_page_context)
    ...
    // /libs/core/components/init/init.jsp(28,6) name = categories type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

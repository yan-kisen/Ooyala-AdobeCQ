package org.apache.jsp.libs.foundation.components.form.captcha;
...
public final class captcha_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    final boolean hideTitle = properties.get("hideTitle", false);
      ...
      out.write("    var captchaStartTime = 0;\n");
      out.write("\n");
      out.write("    function captchaRefresh() {\n");
      out.write("        var captchakey = (\"\" + Math.random()).substring(3, 8);\n");
      out.write("        var captchaimg = document.getElementById(\"cq_captchaimg\");\n");
      out.write("        var captchakeyelem = document.getElementById(\"cq_captchakey\");\n");
      out.write("        captchaimg.src = CQ.shared.HTTP.getXhrHookedURL(CQ.shared.HTTP.externalize(\"");
      out.print( resource.getPath() );
      out.write(".captcha.png?id=\" + captchakey));\n");
      out.write("        captchakeyelem.value = captchakey;\n");
      out.write("        captchaStartTime = new Date().getTime();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function captchaTimer() {\n");
      out.write("        var now = new Date().getTime();\n");
      out.write("        if ((now - captchaStartTime) > 60000) {\n");
      out.write("            captchaRefresh();\n");
      out.write("        }\n");
      out.write("        var captchatimer = document.getElementById(\"cq_captchatimer\");\n");
      out.write("        if (!captchatimer) {\n");
      out.write("            // captcha has been removed\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        var width = Math.floor((60000 - (now - captchaStartTime)) / 60000 * 64);\n");
      out.write("        captchatimer.innerHTML = \"<div class=\\\"form_captchatimer_bar\\\" style=\\\"width:\" + width + \"px;\\\"></div>\";\n");
      out.write("        window.setTimeout(captchaTimer, 500);\n");
      out.write("    }\n");
      out.write("</script>\n");
      out.write("<input type=\"hidden\" name=\":cq:captchakey\" id=\"cq_captchakey\" value=\"\"/>\n");
 ...
 LayoutHelper.printTitle(":cq:captcha", title, required, hideTitle, out); 
      ...
      out.write("        <div class=\"form_captcha_input\"><input type=\"text\" id=\":cq:captcha\" name=\":cq:captcha\" class=\"");
      out.print( FormsHelper.getCss(properties, "form_field form_field_text") );
      out.write("\" size=\"6\"/></div>\n");
      out.write("        <div class=\"form_captcha_img\"><img id=\"cq_captchaimg\" src=\"");
      out.print( resource.getPath() );
      out.write(".captcha.png?id=123\" alt=\"\"></div>\n");
      out.write("        <div class=\"form_captcha_refresh\"><input type=\"button\" onclick=\"captchaRefresh()\" value=\"");
      out.print(i18n.get("refresh"));
      out.write("\" class=\"");
      out.print( FormsHelper.getCss(properties, "form_button") );
      out.write("\"></div>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("<div class=\"form_row\">\n");
 ...
 LayoutHelper.printTitle(null, null, false, hideTitle, out); 
      out.write("\n");
      out.write("    <div class=\"form_rightcol\"><div id=\"cq_captchatimer\" class=\"form_captchatimer\" style=\"width: 63px;\"></div></div>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("        captchaTimer();\n");
      out.write("</script>");

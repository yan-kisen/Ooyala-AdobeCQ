...
public final class namespacesoptions_json_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    for (Tag ns : tagManager.getNamespaces()) {
      ...
      out.write("\"text\":\"");
      out.print( xssAPI.encodeForJSString(xssAPI.encodeForHTMLAttr(ns.getTitle())) );
      out.write('"');
      out.write(',');

            
      out.write("\"value\":\"");
      out.print( xssAPI.encodeForJSString(xssAPI.encodeForHTMLAttr(ns.getName())) );
      out.write('"');

package org.apache.jsp.libs.foundation.components.account.passwordreset;
...
public final class passwordreset_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
 ...
 LayoutHelper.printTitle(id, title, required, hideTitle, out); 
      out.write("\n");
      out.write("  <div class=\"form_rightcol\"><input class=\"geo textinput\" name=\"");
      out.print(name);
      out.write("\" value=\"\" type=\"password\" size=\"");
      out.print(cols );
      out.write('"');
      out.write(' ');
 ...
 LayoutHelper.printTitle(id, confirmTitle, required, hideConfirmTitle, out); 
      ...
      out.write("  <div class=\"form_rightcol\"><input class=\"geo textinput\" name=\"");
      out.print(name);
      out.write("_confirm\" value=\"\" type=\"password\" size=\"");
      out.print(cols );
      out.write('"');
      out.write(' ');
      out.print( (width.length()>0?"style='width:"+width+"px;'":"") );
  ...
  if (key != null && uid != null) {
      ...
      out.print(uid);
      out.write("\">\n");
      out.write("  <input type=\"hidden\" name=\"ky\" value=\"");
      out.print(key);
      out.write('"');
      out.write('>');
      out.write('\n');

package org.apache.jsp.libs.foundation.components.account.accountname;
...
public final class accountname_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
 ...
 LayoutHelper.printTitle(id, title, required, hideTitle, out); 
      ...
      out.write("value=\"");
      out.print( xssAPI.encodeForHTMLAttr(uid) );
      out.write('"');
      out.write(' ');

package org.apache.jsp.libs.foundation.components.form.dropdown;
...
public final class dropdown_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
 ...
 LayoutHelper.printTitle(id, title, required, hideTitle, out); 
      ...
      out.print( FormsHelper.getCss(properties, "form_field form_field_select") );
      out.write("\" id=\"");
      out.print(id );
      out.write("\" name=\"");
      out.print(name);

package org.apache.jsp.libs.foundation.components.breadcrumb;
...
public final class breadcrumb_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    while (level < currentLevel - endLevel) {
      ...
      out.print( xssAPI.filterHTML(delim) );

        
      out.write("<a href=\"");
      out.print( xssAPI.getValidHref(trail.getPath()+".html") );
      out.write("\" onclick=\"record('followBreadcrumb', { breadcrumbPath: '");
      out.print( xssAPI.getValidHref(trail.getPath()) );
      out.write("' }, false, { obj: this })\">");
    ...
    if (trailStr.length() > 0) {
      ...
      out.print( xssAPI.filterHTML(trailStr) );

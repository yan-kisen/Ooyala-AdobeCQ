package org.apache.jsp.libs.foundation.components.profile.form.avatar;
...
public final class avatar_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/libs/foundation/components/profile/form/avatar/../init.jsp");
  }
...
//    final String cols = properties.get("cols", "35");
    ...
    if (primPhoto != null) {
      ...
      out.write("<img src=\"");
      out.print( img.getFileNodePath());
      out.write(".prof.thumbnail.");
      out.print(
                ImageHelper.getExtensionFromType(img.getMimeType()) == null?
                "png" : ImageHelper.getExtensionFromType(img.getMimeType()) );
      out.write("\"\n");
      out.write("                 alt=\"");
      out.print(Text.escape(profile.getFormattedName()));
      out.write("\"\n");
      out.write("                 style=\"float:left;padding-right:10px;\" />");

            size="12";
            
      out.write("<span><input type=\"checkbox\" onclick=\"{if (this.checked) {this.name='");
      out.print( path);
      out.write("@Delete';} else {this.name = ''; }}\"/>");
      out.print(properties.get("deleteTitle", i18n.get("Delete")));
      out.write("</span><br>");

            }
        
      out.write("<input class=\"geo\" id=\"");
      out.print( id );
      out.write("\" name=\"");
      out.print(path);
      out.write("/image\" type=\"file\" size=\"");
      out.print( size );
      out.write('"');
      out.write(' ');
      out.print( (width.length()>0?"style='width:"+width+"px;'":"") );
      out.write("></div>\n");
      out.write("        <input type=\"hidden\" name=\"");
      out.print(path);
      out.write("/primary\" value=\"true\">\n");
      out.write("</div>");
    } catch (Throwable t) {

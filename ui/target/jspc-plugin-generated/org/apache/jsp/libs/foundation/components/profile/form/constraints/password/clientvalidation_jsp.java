package org.apache.jsp.libs.foundation.components.profile.form.constraints.password;
...
public final class clientvalidation_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    final String formId = FormsHelper.getFormId(slingRequest);
      ...
      out.write("    var elem = document.forms[\"");
      out.print( xssAPI.encodeForJSString(formId) );
      out.write("\"].elements;\n");
      out.write("    var last, confirm;\n");
      out.write("    for (var i=0; i < elem.length; i++) {\n");
      out.write("       var name = elem[i].name;\n");
      out.write("       if (name=='");
      out.print( xssAPI.encodeForJSString(name) );
      out.write("') {\n");
      out.write("            last = elem[i].value;       \n");
      out.write("       } else if (name=='");
      out.print( xssAPI.encodeForJSString(name) );
      out.write("_confirm') {\n");
      out.write("            confirm = elem[i].value;\n");
      out.write("            break;\n");
      out.write("       }   \n");
      out.write("    }\n");
      out.write("    if(last!=confirm) {\n");
      ...
      out.write('\'');
      out.print( xssAPI.encodeForJSString(ValidationHelper.getConstraintMessage(resource)) );
      out.write("');\n");

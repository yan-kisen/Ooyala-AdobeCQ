package org.apache.jsp.libs.foundation.components.primary.nt.folder;
...
public final class segment_js_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
    ...
    while(iter.hasNext()) {
        ...
        if(!NameConstants.NN_CONTENT.equals(Text.getName(child.getPath()))) {
            try {
                ...
                logger.warn("Error while including sub segment",child.getPath());
            }
        }
    }

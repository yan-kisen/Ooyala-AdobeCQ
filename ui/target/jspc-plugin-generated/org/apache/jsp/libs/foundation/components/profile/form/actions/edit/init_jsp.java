...
if (profile!=null && profile.getAuthorizable()!=null) {
	target.append("?authorizable=").append(profile.getAuthorizable().getID());
      ...
      out.write("\tvar frm = document.forms['");
      out.print( FormsHelper.getFormId(slingRequest));
      out.write("'];\n");
      out.write("\tvar elem = document.createElement(\"input\");\n");
 if (profile!=null) {
	
      out.write("\n");
      out.write("\telem.value= '");
      out.print( profile.getPath() );
      out.write("';\n");
      out.write("\telem.name=\":profile\";\n");
      out.write("\telem.type=\"hidden\";\n");
      out.write("\tfrm.appendChild(elem);\n");
      ...
      out.write("    frm.appendChild(elem);\n");
      out.write("}\n");
      out.write("window.attachEvent ? window.attachEvent(\"onload\", addPath): window.addEventListener(\"load\", addPath, false) ;\n");
      out.write(" \n");
      out.write("</script>\n");
    } catch (Throwable t) {

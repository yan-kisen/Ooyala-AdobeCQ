...
public final class head_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String title = currentPage.getTitle() == null ? currentPage.getName() : currentPage.getTitle();
      ...
      out.print( WCMUtils.getKeywords(currentPage) );
      out.write('"');
      out.print(xs);
      out.write(">\n");
      out.write("    ");
 currentDesign.writeCssIncludes(pageContext); 
  ...
  private boolean _jspx_meth_cq_005finclude_005f0(PageContext _jspx_page_context)
    ...
    // /libs/cq/cloudserviceconfigs/components/configpage/head.jsp(11,4) name = script type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

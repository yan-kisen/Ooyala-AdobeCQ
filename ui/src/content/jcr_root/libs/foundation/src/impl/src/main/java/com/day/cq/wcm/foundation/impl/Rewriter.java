/*
 * $Id: Rewriter.java 60840 2009-11-13 16:39:48Z cziegele $
 *
    ...
    public void onStartElement(String name, AttributeList attList,
        ...
        if (limit != Limit.OFF) {
            if (upperName.equals("A")) {
                // check if the A has a type attribute specified.
                // rewrite all to spool if enabled
                boolean spool = respectTypeAttribute && attList.containsAttribute("type");
                rewriteRef(attList, "HREF", spool);

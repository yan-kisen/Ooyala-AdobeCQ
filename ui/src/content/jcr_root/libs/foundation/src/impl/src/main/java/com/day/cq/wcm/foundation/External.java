...
public class External {
    ...
    public External(Resource resource, Page page, String spoolSelector, String postSelector, String targetParam) {
        ...
        this.properties = resource == null ? ValueMap.EMPTY : resource.adaptTo(ValueMap.class);
        this.node = resource == null ? null : resource.adaptTo(Node.class);
    ...
    /**
     * Return a flag indicating whether parameters should be passed to
     * the external site.
     *
     * @return <code>true</code> if the parameters should be passed;
    ...
    /**
     * Return a flag indicating whether the external site should be included
     * adaptive (rewritten html) or fixed (as an IFRAME).
     *
     * @return <code>true</code> if the external site should be included fixed;
     *         <code>false</code> otherwise
     */
    ...
    public void draw(HttpServletRequest request, HttpServletResponse response)
        ...
        Rewriter rewriter = new Rewriter(pagePath, resourcePath,
                target, postSelector, targetParam);
        rewriter.setPassInput(passParameters());

...
@Component
@Service
public class StartWorkflowPostProcessor extends AbstractRepositoryService implements SlingPostProcessor {
    ...
    public void process(SlingHttpServletRequest request, List<Modification> mods) throws Exception {
        ...
        if(workflowModelPath == null) {
            ...
            final WorkflowSession wfs = workflowService.getWorkflowSession(getAdminSession());
